...
contract TaskRegistry {
    ...
    mapping(Task => int16) public tasksScore;
    mapping(uint256 => TaskRange) private taskRanges;
    mapping(uint256 => randomNTask) private tasksForEachPlayer;
    ...
    function getTaskScore(Task _task) external view returns (int16) {
    ...
    /// @notice Get the list of short tasks
    ...
    // TODO : Write Code assign RandomN task
    // function assignRandomTaskCount(uint256 _playerCount) external onlyTrustedCallers {
    // if (_playerCount < 4 || _playerCount > 9) revert InvalidPlayerSize();
    // taskRange = taskRanges[]
    // }
